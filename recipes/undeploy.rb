...
every_enabled_application do |application|
  ...
  fire_hook(:before_undeploy, items: databases + [scm, framework, appserver, renderer, worker, webserver])
  ...
  fire_hook(:after_undeploy, items: databases + [scm, framework, appserver, renderer, worker, webserver])
end
