...
every_enabled_application do |application|
  ...
  fire_hook(:before_undeploy, items: databases + renderers + [scm, framework, appserver, worker, webserver])
  ...
  fire_hook(:after_undeploy, items: databases + renderers + [scm, framework, appserver, worker, webserver])
end
